...
const VARIANT_HOST_MAP: Record<string, string> = {
  'tech.zmonitor.app': 'tech',
  'finance.zmonitor.app': 'finance',
  'commodity.zmonitor.app': 'commodity',
  'happy.zmonitor.app': 'happy',
};
...
const VARIANT_OG: Record<string, { title: string; description: string; image: string; url: string }> = {
  tech: {
    ...
    image: 'https://tech.zmonitor.app/favico/tech/og-image.png',
    url: 'https://tech.zmonitor.app/',
  },
  finance: {
    title: 'Finance Monitor - Real-Time Markets & Trading Dashboard',
    description: 'Real-time finance and trading dashboard tracking global markets, stock exchanges, central banks, commodities, forex, crypto, and economic indicators worldwide.',
    image: 'https://finance.zmonitor.app/favico/finance/og-image.png',
    url: 'https://finance.zmonitor.app/',
  },
  commodity: {
    ...
    image: 'https://commodity.zmonitor.app/favico/commodity/og-image.png',
    url: 'https://commodity.zmonitor.app/',
  },
  happy: {
    ...
    image: 'https://happy.zmonitor.app/favico/happy/og-image.png',
    url: 'https://happy.zmonitor.app/',
  },
};
