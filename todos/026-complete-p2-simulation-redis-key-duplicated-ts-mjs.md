...
// server/zmonitor/forecast/v1/get-simulation-outcome.ts — replace local const:
...
- Files: `server/zmonitor/forecast/v1/get-simulation-outcome.ts:10`, `server/zmonitor/forecast/v1/get-simulation-package.ts:~10`, `server/_shared/cache-keys.ts`
