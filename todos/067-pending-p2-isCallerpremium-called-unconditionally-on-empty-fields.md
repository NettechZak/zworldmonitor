...
## Technical Details
- Files: `server/zmonitor/news/v1/summarize-article.ts:42`, `server/zmonitor/intelligence/v1/deduct-situation.ts:26`, `server/zmonitor/intelligence/v1/get-country-intel-brief.ts`
