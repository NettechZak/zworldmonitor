...
- Server relay callers: `server/zmonitor/*` handlers
...
| `RELAY_SHARED_SECRET` | Yes | `zm_relay_prod_...` | Must exactly match Vercel value. |
...
| `RELAY_SHARED_SECRET` | Yes | `zm_relay_prod_...` | Must exactly match Railway value. |
