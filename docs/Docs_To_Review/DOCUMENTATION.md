...
🌐 **[Live Demo: zmonitor.app](https://zmonitor.app)** | 💻 **[Tech Variant: tech.zmonitor.app](https://tech.zmonitor.app)**
...
![Z-Monitor Dashboard](images/new-world-monitor.png)

## Platform Variants

Z-Monitor runs two specialized variants from a single codebase, each optimized for different monitoring needs:

| Variant | URL | Focus |
|---------|-----|-------|
| **🌍 Z-Monitor** | [zmonitor.app](https://zmonitor.app) | Geopolitical intelligence, military tracking, conflict monitoring, infrastructure security |
| **💻 Tech Monitor** | [tech.zmonitor.app](https://tech.zmonitor.app) | Technology sector intelligence, AI/startup ecosystems, cloud infrastructure, tech events |
...
The tech variant ([tech.zmonitor.app](https://tech.zmonitor.app)) provides specialized layers for technology sector monitoring.
...
The Service Status panel tracks the operational health of external services that Z-Monitor users may depend on.
...
// App.ts
const header = `Z-Monitor v${__APP_VERSION__}`;
```
...
git clone https://github.com/NettechZak/zmonitor.git
cd zmonitor
...
- ✅ **Variant Switcher UI** - Compact orbital navigation between Z-Monitor and Tech Monitor
...
2. **Clone your fork** locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/zmonitor.git
   cd zmonitor
   ```
