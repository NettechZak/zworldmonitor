...
Comprehensive data model documentation for **Z-Monitor** — an AI-powered real-time global intelligence dashboard. This reference covers all TypeScript interfaces, data structures, and their relationships across the system.
...
|-----|----------|--------------|
| `zmonitor-panel-spans` | `PANEL_SPANS_KEY` | `Record<string, number>` — panel ID → grid span (1–4) |
...
Database: `zmonitor_db`, version 1.
...
- Key prefix: `zmonitor-persistent-cache:`
