...
If you discover a security vulnerability in Z-Monitor, please report it responsibly:

1. **GitHub Private Vulnerability Reporting**: Use [GitHub's private vulnerability reporting](https://github.com/NettechZak/zworldmonitor/security/advisories/new) to submit your report directly through the repository.

2. **Direct Contact**: Alternatively, reach out to the repository owner [@NettechZak](https://github.com/NettechZak) directly through GitHub.
...
Z-Monitor is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- Z-Monitor aggregates publicly available OSINT data
...
- Vulnerabilities in the Z-Monitor codebase
...
Thank you for helping keep Z-Monitor and its users safe! 🔒
