...
- src/snapshots/zmonitor.ts: retailer spread query — add AND pm.pin_disabled_at IS NULL
...
snapshots/zmonitor.ts buildRetailerSpreadSnapshot:
...
In zmonitor repo: src/services/consumer-prices/index.ts
...
21. Separate PR in zmonitor repo: remove ke from MARKETS (Task 11)
