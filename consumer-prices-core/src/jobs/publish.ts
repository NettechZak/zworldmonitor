/**
 * Publish job: builds compact Z-Monitor snapshot payloads and writes to Redis.
 * Runs as an independent Railway cron service (02:30 UTC daily) after aggregate.
 * This is the handoff point between consumer-prices-core and Z-Monitor.
 */
import {
