 ...
 *   - server/zmonitor/cyber/v1/_shared.ts
 *   - server/zmonitor/news/v1/_shared.ts  (+ dedup.mjs + hash.ts)
 *   - server/zmonitor/infrastructure/v1/get-cable-health.ts
 *
 * NOTE: server/zmonitor/military/v1/get-usni-fleet-report.ts has many useful
...
import {
  ...
  SEVERITY_RANK,
  type RawThreat,
} from '../server/zmonitor/cyber/v1/_shared.ts';

// ---------------------------------------------------------------------------
// News domain helpers
// ---------------------------------------------------------------------------
import { deduplicateHeadlines } from '../server/zmonitor/news/v1/dedup.mjs';
import { buildArticlePrompts, hashString } from '../server/zmonitor/news/v1/_shared.ts';
...
import {
  ...
  processNgaSignals,
  computeHealthMap,
} from '../server/zmonitor/infrastructure/v1/get-cable-health.ts';
