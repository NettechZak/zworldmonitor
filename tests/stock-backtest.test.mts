...
import { backtestStock } from '../server/zmonitor/market/v1/backtest-stock.ts';
import { listStoredStockBacktests } from '../server/zmonitor/market/v1/list-stored-stock-backtests.ts';
import { MarketServiceClient } from '../src/generated/client/zmonitor/market/v1/service_client.ts';
