...
function loadRelayFunctions() {
  ...
  const CHROME_UA = 'Z-Monitor-Test-UA';
...
describe('getRelayHeaders — no auth', () => {
  ...
  it('aviation User-Agent override works', () => {
    const h = getRelayHeaders({ 'User-Agent': 'Z-Monitor-Server/1.0' });
    assert.equal(h['User-Agent'], 'Z-Monitor-Server/1.0');
  });
});
...
describe('relay.ts — consumer import verification', () => {
  const consumers = [
    { file: 'server/zmonitor/aviation/v1/_shared.ts', importPath: '../../../_shared/relay' },
    { file: 'server/zmonitor/intelligence/v1/_relay.ts', importPath: '../../../_shared/relay' },
    { file: 'server/zmonitor/research/v1/list-tech-events.ts', importPath: '../../../_shared/relay' },
    { file: 'server/zmonitor/maritime/v1/get-vessel-snapshot.ts', importPath: '../../../_shared/relay' },
    { file: 'server/zmonitor/market/v1/_shared.ts', importPath: '../../../_shared/relay' },
    { file: 'server/zmonitor/news/v1/list-feed-digest.ts', importPath: '../../../_shared/relay' },
    { file: 'server/zmonitor/military/v1/list-military-flights.ts', importPath: '../../../_shared/relay' },
  ];
  ...
  it('no local getRelayBaseUrl/getRelayHeaders/getRelayRequestHeaders definitions in server/ (except _shared/relay.ts)', () => {
    const dupeFiles = [
      'server/zmonitor/aviation/v1/_shared.ts',
      'server/zmonitor/intelligence/v1/_relay.ts',
      'server/zmonitor/research/v1/list-tech-events.ts',
      'server/zmonitor/maritime/v1/get-vessel-snapshot.ts',
      'server/zmonitor/market/v1/_shared.ts',
      'server/zmonitor/news/v1/list-feed-digest.ts',
      'server/zmonitor/military/v1/list-military-flights.ts',
    ];
  ...
  it('military list-military-flights.ts uses getRelayBaseUrl() not raw WS_RELAY_URL + /opensky', () => {
    const src = readFileSync(resolve('server/zmonitor/military/v1/list-military-flights.ts'), 'utf-8');
    assert.ok(
