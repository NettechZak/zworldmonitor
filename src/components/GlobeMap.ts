 ...
 *
 * Matches ZMonitor's MapContainer API so it can be used as a drop-in
...
export class GlobeMap {
  ...
  private webcamMarkerMode: string = localStorage.getItem('zm-webcam-marker-mode') || 'icon';
  ...
  private createLayerToggles(): void {
    ...
    const _wmKey = getSecretState('ZMONITOR_API_KEY').present;
    ...
    if (webcamToggleEl) {
      ...
      const currentMode = (): string => localStorage.getItem('zm-webcam-marker-mode') || 'icon';
      ...
      modeBtn.addEventListener('click', (e) => {
        ...
        localStorage.setItem('zm-webcam-marker-mode', next);
