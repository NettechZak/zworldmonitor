...
export const DESKTOP_PARITY_FEATURES: DesktopParityFeature[] = [
  ...
  },
  {
    ...
    apiHandlers: ['server/zmonitor/conflict/v1/handler.ts', 'server/zmonitor/infrastructure/v1/handler.ts', 'server/zmonitor/cyber/v1/handler.ts', 'server/zmonitor/maritime/v1/handler.ts', 'server/zmonitor/military/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/zmonitor/news/v1/handler.ts'],
    locality: 'api-key',
  ...
  },
  {
    ...
    apiHandlers: ['server/zmonitor/market/v1/handler.ts'],
    locality: 'fully-local',
  ...
  },
  {
    ...
    apiHandlers: ['server/zmonitor/military/v1/handler.ts'],
    locality: 'api-key',
