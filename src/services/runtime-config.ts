...
const TOGGLES_STORAGE_KEY = 'zmonitor-runtime-feature-toggles';
...
export async function setSecretValue(key: RuntimeSecretKey, value: string): Promise<void> {
  ...
  try {
    localStorage.setItem('zm-secrets-updated', String(Date.now()));
