  ...
  return {
    ...
    transformIndexHtml(html) {
      let result = html
        ...
        .replace(/"name": "Z-Monitor"/, `"name": "${activeMeta.siteName}"`)
        .replace(/"alternateName": "Z-Monitor"/, `"alternateName": "${activeMeta.siteName.replace(' ', '')}"`)
        .replace(/"url": "https:\/\/zmonitor\.app\/"/, `"url": "${activeMeta.url}"`)
  ...
  async function buildRouter() {
    const [
      ...
      naturalServerMod, naturalHandlerMod,
        ...
        import('./src/generated/server/zmonitor/seismology/v1/service_server'),
        import('./server/zmonitor/seismology/v1/handler'),
        import('./src/generated/server/zmonitor/wildfire/v1/service_server'),
        import('./server/zmonitor/wildfire/v1/handler'),
        import('./src/generated/server/zmonitor/climate/v1/service_server'),
        import('./server/zmonitor/climate/v1/handler'),
        import('./src/generated/server/zmonitor/prediction/v1/service_server'),
        import('./server/zmonitor/prediction/v1/handler'),
        import('./src/generated/server/zmonitor/displacement/v1/service_server'),
        import('./server/zmonitor/displacement/v1/handler'),
        import('./src/generated/server/zmonitor/aviation/v1/service_server'),
        import('./server/zmonitor/aviation/v1/handler'),
        import('./src/generated/server/zmonitor/research/v1/service_server'),
        import('./server/zmonitor/research/v1/handler'),
        import('./src/generated/server/zmonitor/unrest/v1/service_server'),
        import('./server/zmonitor/unrest/v1/handler'),
        import('./src/generated/server/zmonitor/conflict/v1/service_server'),
        import('./server/zmonitor/conflict/v1/handler'),
        import('./src/generated/server/zmonitor/maritime/v1/service_server'),
        import('./server/zmonitor/maritime/v1/handler'),
        import('./src/generated/server/zmonitor/cyber/v1/service_server'),
        import('./server/zmonitor/cyber/v1/handler'),
        import('./src/generated/server/zmonitor/economic/v1/service_server'),
        import('./server/zmonitor/economic/v1/handler'),
        import('./src/generated/server/zmonitor/infrastructure/v1/service_server'),
        import('./server/zmonitor/infrastructure/v1/handler'),
        import('./src/generated/server/zmonitor/market/v1/service_server'),
        import('./server/zmonitor/market/v1/handler'),
        import('./src/generated/server/zmonitor/news/v1/service_server'),
        import('./server/zmonitor/news/v1/handler'),
        import('./src/generated/server/zmonitor/intelligence/v1/service_server'),
        import('./server/zmonitor/intelligence/v1/handler'),
        import('./src/generated/server/zmonitor/military/v1/service_server'),
        import('./server/zmonitor/military/v1/handler'),
        import('./src/generated/server/zmonitor/positive_events/v1/service_server'),
        import('./server/zmonitor/positive-events/v1/handler'),
        import('./src/generated/server/zmonitor/giving/v1/service_server'),
        import('./server/zmonitor/giving/v1/handler'),
        import('./src/generated/server/zmonitor/trade/v1/service_server'),
        import('./server/zmonitor/trade/v1/handler'),
        import('./src/generated/server/zmonitor/supply_chain/v1/service_server'),
        import('./server/zmonitor/supply-chain/v1/handler'),
        import('./src/generated/server/zmonitor/natural/v1/service_server'),
        import('./server/zmonitor/natural/v1/handler'),
      ]);
  ...
  return {
    ...
    server: {
      ...
      proxy: {
        ...
        '/widget-agent': {
          target: 'https://proxy.zmonitor.app',
          changeOrigin: true,
        },
        // Yahoo Finance API
        '/api/yahoo': {
